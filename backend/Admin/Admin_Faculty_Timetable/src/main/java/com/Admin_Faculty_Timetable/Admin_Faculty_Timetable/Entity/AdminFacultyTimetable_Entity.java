package com.Admin_Faculty_Timetable.Admin_Faculty_Timetable.Entity;

import jakarta.persistence.*;

@Entity
@Table(name = "Admin_Faculty_Timetable")
public class AdminFacultyTimetable_Entity {
    ...
    public AdminFacultyTimetable_Entity() {};
